...
public class OfficialActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Government official = (Government) intent.getSerializableExtra("officalObject");
        setContent(official);
        ...
        officialImg.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intentImg = new Intent(OfficialActivity.this, OfficialImgActivity.class);
    ...
    private void setBackgroundByParty(String party){
        switch (party) {
            case "Democratic Party":
                getWindow().getDecorView().setBackgroundColor(ContextCompat.getColor(OfficialActivity.this, R.color.blue));
                break;
            case "Republican Party":
                getWindow().getDecorView().setBackgroundColor(ContextCompat.getColor(OfficialActivity.this, R.color.red));
                break;
            case "Nonpartisan":
                getWindow().getDecorView().setBackgroundColor(ContextCompat.getColor(OfficialActivity.this, R.color.black));
                break;
        }
    }

    private void setSocialMedia(Government official){
    ...
    private void setContent(Government official){
        ...
        if(!official.getImg().equals("")){
            Picasso picasso = new Picasso.Builder(OfficialActivity.this).listener(new Picasso.Listener() {
                @Override
